...
:mainscrn
cls
echo Welcome to Survival %ver% where you have to survive on your own with limited money and supplies.
echo.
echo.
echo Create A GameFile:
echo.
echo.
set /p gamepr=Enter Your Gamertag:
echo.
echo.
cls
for /L %%i in (1,1,2) do (
...
:inv
cls
if total_items==0 goto blank_inv
else (
cls
echo You have:
echo.
...
if %exit1%==n goto Mainscreen_v14
...
if errorlevel 4 goto Mainscreen_v14
